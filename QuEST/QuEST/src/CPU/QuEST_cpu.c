...
#pragma omp parallel default(none) \
    shared(innerMask, outerMask, totMask, qureg, retain) private(thisTask, thisPattern)
#endif
    {
#ifdef _OPENMP
...
#pragma omp parallel default(none)                                                            \
    shared(innerMaskQubit1, outerMaskQubit1, totMaskQubit1, innerMaskQubit2, outerMaskQubit2, \
           totMaskQubit2, qureg, retain) private(thisTask, thisPatternQubit1, thisPatternQubit2)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(innerMask, outerMask, totMask, qureg, retain, depolLevel) private(thisTask, partner, thisPattern, realAv, imagAv)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
        ...
        for (thisTask = 0; thisTask < numTasks; thisTask++)
        {
            ...
            {
                if ((thisTask & totMask) == 0)
                { //this element relates to targetQubit in state 0
                    // do depolarise
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(innerMask, outerMask, totMask, qureg, retain, damping, dephase) private(thisTask, partner, thisPattern)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none)                                                                                                                                                            \
    shared(sizeInnerBlock, sizeInnerHalfBlock, sizeOuterColumn, sizeOuterHalfColumn, qureg, depolLevel) private(thisTask, thisInnerBlock, thisOuterColumn, thisIndex, thisIndexInOuterColumn, \
...
#pragma omp for schedule(static)
        ...
        for (thisTask = 0; thisTask < numTasks; thisTask++)
        {
            ...
            thisIndex = thisOuterColumn * sizeOuterColumn + thisInnerBlock * sizeInnerBlock + thisIndexInInnerBlock;
...
#ifdef _OPENMP
#pragma omp parallel default(none)                                                                                                                                                                          \
    shared(sizeInnerBlock, sizeInnerHalfBlock, sizeOuterColumn, sizeOuterHalfColumn, qureg, damping, retain, dephase) private(thisTask, thisInnerBlock, thisOuterColumn, thisIndex, thisIndexInOuterColumn, \
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(totMaskQubit1, totMaskQubit2, qureg, delta, gamma) private(thisTask, partner, thisPatternQubit1, thisPatternQubit2, real00, imag00)
#endif
    {
...
#pragma omp for schedule(static)
        ...
        for (thisTask = 0; thisTask < numTasks; thisTask++)
        {
            thisPatternQubit1 = (thisTask + qureg.numAmpsPerChunk * qureg.chunkId) & totMaskQubit1;
            thisPatternQubit2 = (thisTask + qureg.numAmpsPerChunk * qureg.chunkId) & totMaskQubit2;
            if ((thisPatternQubit1 == 0) && ((thisPatternQubit2 == 0) || (thisPatternQubit2 == totMaskQubit2)))
            {
                ...
                qureg.stateVec.real[thisTask] = qureg.stateVec.real[thisTask] + delta * qureg.stateVec.real[partner];
                qureg.stateVec.imag[thisTask] = qureg.stateVec.imag[thisTask] + delta * qureg.stateVec.imag[partner];
...
#pragma omp for schedule(static)
        ...
        for (thisTask = 0; thisTask < numTasks; thisTask++)
        {
            thisPatternQubit1 = (thisTask + qureg.numAmpsPerChunk * qureg.chunkId) & totMaskQubit1;
            thisPatternQubit2 = (thisTask + qureg.numAmpsPerChunk * qureg.chunkId) & totMaskQubit2;
            if ((thisPatternQubit2 == 0) && ((thisPatternQubit1 == 0) || (thisPatternQubit1 == totMaskQubit1)))
            {
...
#pragma omp for schedule(static)
        ...
        for (thisTask = 0; thisTask < numTasks; thisTask++)
        {
            ...
            if ((thisPatternQubit2 == 0) && ((thisPatternQubit1 == 0) || (thisPatternQubit1 == totMaskQubit1)))
            {
                ...
                qureg.stateVec.real[thisTask] = gamma * (qureg.stateVec.real[thisTask] + delta * qureg.stateVec.real[partner]);
                qureg.stateVec.imag[thisTask] = gamma * (qureg.stateVec.imag[thisTask] + delta * qureg.stateVec.imag[partner]);

                qureg.stateVec.real[partner] = gamma * (qureg.stateVec.real[partner] + delta * real00);
                qureg.stateVec.imag[partner] = gamma * (qureg.stateVec.imag[partner] + delta * imag00);
            }
        }
    }
}
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(totMaskQubit1, totMaskQubit2, qureg, delta) private(thisTask, partner, thisPatternQubit1, thisPatternQubit2, real00, imag00)
#endif
    {
...
#pragma omp parallel default(none)                                                                                                           \
    shared(sizeInnerBlockQ1, sizeInnerHalfBlockQ1, sizeInnerBlockQ2, sizeInnerHalfBlockQ2, sizeInnerQuarterBlockQ2,                          \
           sizeOuterColumn, sizeOuterQuarterColumn, qureg, delta, gamma) private(thisTask, thisInnerBlockQ2, thisInnerBlockQ1InInnerBlockQ2, \
...
#pragma omp for schedule(static)
        ...
        for (thisTask = 0; thisTask < numTasks; thisTask++)
        {
            ...
            // get index in state vector corresponding to upper inner block
            thisIndex = thisOuterColumn * sizeOuterColumn + thisInnerBlockQ2 * sizeInnerBlockQ2 + thisInnerBlockQ1InInnerBlockQ2 * sizeInnerBlockQ1 + thisIndexInInnerBlockQ1;
...
#ifdef _OPENMP
#pragma omp parallel                             \
    shared(vecRe, vecIm, numAmps) private(index) \
        reduction(+                              \
                  : trace)
#endif
    {
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(combineVecRe, combineVecIm, otherVecRe, otherVecIm, otherProb, numAmps) private(index)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel                                                 \
    shared(aRe, aIm, bRe, bIm, numAmps) private(index, difRe, difIm) \
        reduction(+                                                  \
                  : trace)
#endif
    {
...
#ifdef _OPENMP
#pragma omp parallel                                   \
    shared(aRe, aIm, bRe, bIm, numAmps) private(index) \
        reduction(+                                    \
                  : trace)
#endif
    {
...
#ifdef _OPENMP
#pragma omp parallel                                                                                                                                                         \
    shared(vecRe, vecIm, densRe, densIm, dim, colsPerNode, startCol) private(row, col, prefacRe, prefacIm, rowSumRe, rowSumIm, densElemRe, densElemIm, vecElemRe, vecElemIm) \
        reduction(+                                                                                                                                                          \
                  : globalSumRe)
#endif
    {
...
#ifdef _OPENMP
#pragma omp parallel                                                                                           \
    shared(braVecReal, braVecImag, ketVecReal, ketVecImag, numAmps) private(index, braRe, braIm, ketRe, ketIm) \
        reduction(+                                                                                            \
                  : innerProdReal, innerProdImag)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(densityNumElems, densityReal, densityImag) private(index)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(chunkSize, densityReal, densityImag, probFactor) private(index)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(colOffset, colsPerNode, rowsPerNode, vecRe, vecIm, densRe, densIm) private(col, row, ketRe, ketIm, braRe, braIm, index)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(localStartInd, localEndInd, vecRe, vecIm, reals, imags, offset) private(index)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
void statevec_createQureg(Qureg *qureg, int numQubits, QuESTEnv env)
{
    ...
    long long int numAmpsPerRank = 0;
    long long int numAmpsPerRank_pair = numAmps / 4;
    if (env.rank == 0)
    {
        numAmpsPerRank = numAmps / 4;
    }
    else if (env.rank == 1)
    {
        numAmpsPerRank = numAmps / 4 * 3;
    }
    ...
    size_t arrSize_pair = (size_t)(numAmpsPerRank_pair * sizeof(*(qureg->stateVec.real)));

    qureg->stateVec.real = malloc(arrSize);
    qureg->stateVec.imag = malloc(arrSize);
    if (env.numRanks > 1)
    {
        qureg->pairStateVec.real = malloc(arrSize_pair);
        qureg->pairStateVec.imag = malloc(arrSize_pair);
    }

    if ((!(qureg->stateVec.real) || !(qureg->stateVec.imag)) && numAmpsPerRank)
    {
        printf("Could not allocate memory!");
        exit(EXIT_FAILURE);
    }

    if (env.numRanks > 1 && (!(qureg->pairStateVec.real) || !(qureg->pairStateVec.imag)) && numAmpsPerRank)
    {
        printf("Could not allocate memory!");
        exit(EXIT_FAILURE);
    }
...
void statevec_reportStateToScreen(Qureg qureg, QuESTEnv env, int reportRank)
{
    ...
    if (qureg.numQubitsInStateVec <= 5)
    {
        ...
        printf("Error: reportStateToScreen will not print output for systems of more than 5 qubits.\n");
}
...
void statevec_initZeroState(Qureg qureg)
{
    ...
    if (qureg.chunkId == 0)
    {
        ...
        float a = (float)qureg.stateVec.real[0];
        // qreal a = qureg.stateVec.real[0];

        // printf("%d\n",sizeof(qureg.stateVec.real[0]));
...
void statevec_initPlusState(Qureg qureg)
{
    ...
    qreal normFactor = 1. / sqrt((qreal)qureg.numAmpsTotal);
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(stateVecSize, targetStateVecReal, targetStateVecImag, copyStateVecReal, copyStateVecImag) private(index)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(chunkSize, stateVecReal, stateVecImag, normFactor, qubitId, outcome) private(index, bit)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(chunkSize, stateVecReal, stateVecImag, indexOffset) private(index)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(sizeBlock, sizeHalfBlock, stateVecReal, stateVecImag, alphaReal, alphaImag, betaReal, betaImag) private(thisTask, thisBlock, indexUp, indexLo, stateRealUp, stateImagUp, stateRealLo, stateImagLo)
#endif
    {
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(reVec, imVec, globalIndStart, numTasks, ctrlMask, u) private(thisTask, thisGlobalInd00, ind00, ind01, ind10, ind11, re00, re01, re10, re11, im00, im01, im10, im11)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(reVec, imVec, numTasks, numTargAmps, globalIndStart, ctrlMask, targs, sortedTargs, u) private(thisTask, thisInd00, thisGlobalInd00, ind, i, t, r, c, reElem, imElem, ampInds, reAmps, imAmps)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(sizeBlock, sizeHalfBlock, stateVecReal, stateVecImag, u) private(thisTask, thisBlock, indexUp, indexLo, stateRealUp, stateImagUp, stateRealLo, stateImagLo)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
        ...
        for (thisTask = 0; thisTask < numTasks; thisTask++)
        {
            ...
            stateVecReal[indexUp] = u.real[0][0] * stateRealUp - u.imag[0][0] * stateImagUp + u.real[0][1] * stateRealLo - u.imag[0][1] * stateImagLo;
            stateVecImag[indexUp] = u.real[0][0] * stateImagUp + u.imag[0][0] * stateRealUp + u.real[0][1] * stateImagLo + u.imag[0][1] * stateRealLo;

            // state[indexLo] = u10  * state[indexUp] + u11 * state[indexLo]
            stateVecReal[indexLo] = u.real[1][0] * stateRealUp - u.imag[1][0] * stateImagUp + u.real[1][1] * stateRealLo - u.imag[1][1] * stateImagLo;
            stateVecImag[indexLo] = u.real[1][0] * stateImagUp + u.imag[1][0] * stateRealUp + u.real[1][1] * stateImagLo + u.imag[1][1] * stateRealLo;
        }
    }
}
...
#pragma omp parallel default(none)                                                                           \
    shared(stateVecRealUp, stateVecImagUp, stateVecRealLo, stateVecImagLo, stateVecRealOut, stateVecImagOut, \
           rot1Real, rot1Imag, rot2Real, rot2Imag) private(thisTask, stateRealUp, stateImagUp, stateRealLo, stateImagLo)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
        ...
        for (thisTask = 0; thisTask < numTasks; thisTask++)
        {
            ...
            // printf("\nThread %d Host %s CPU %d\n", omp_get_thread_num(), processor_name, sched_getcpu());
        }
        // printf("\nThread %d, CPU %d\n", omp_get_thread_num(), sched_getcpu());
    }
}

void statevec_compactUnitaryDistributed_adaptive(Qureg qureg,
                                                 Complex rot1, Complex rot2,
                                                 ComplexArray stateVecUp,
                                                 ComplexArray stateVecLo,
                                                 QuESTEnv env,
                                                 int nonLocalShift,
                                                 long long int updateTasks)
{

    qreal stateRealUp, stateRealLo, stateImagUp, stateImagLo;
    long long int thisTask;
    const long long int numTasks = updateTasks;

    qreal rot1Real = rot1.real, rot1Imag = rot1.imag;
    qreal rot2Real = rot2.real, rot2Imag = rot2.imag;
    qreal *stateVecRealUp = stateVecUp.real, *stateVecImagUp = stateVecUp.imag;
    qreal *stateVecRealLo = &stateVecLo.real[updateTasks * nonLocalShift], *stateVecImagLo = &stateVecLo.imag[updateTasks * nonLocalShift];
    qreal *stateVecRealOut, *stateVecImagOut;

    if (env.rank == 0)
    {
        stateVecRealOut = stateVecRealUp, stateVecImagOut = stateVecImagUp;
    }
    else
    {
        stateVecRealOut = stateVecRealLo, stateVecImagOut = stateVecImagLo;
    }
...
void statevec_compactUnitaryDistributed_adaptive_local(Qureg qureg,
                                                       Complex rot1_up, Complex rot2_up,
                                                       Complex rot1_lo, Complex rot2_lo,
                                                       ...
                                                       int localShift_lo)
{
    ...
    qreal rot1Real_up = rot1_up.real, rot1Imag_up = rot1_up.imag;
    qreal rot2Real_up = rot2_up.real, rot2Imag_up = rot2_up.imag;
    qreal rot1Real_lo = rot1_lo.real, rot1Imag_lo = rot1_lo.imag;
    qreal rot2Real_lo = rot2_lo.real, rot2Imag_lo = rot2_lo.imag;
    qreal *stateVecRealUp = &stateVec.real[updateTasks * localShift_up], *stateVecImagUp = &stateVec.imag[updateTasks * localShift_up];
    qreal *stateVecRealLo = &stateVec.real[updateTasks * localShift_lo], *stateVecImagLo = &stateVec.imag[updateTasks * localShift_lo];
    // qreal *stateVecRealOut = stateVecOut.real, *stateVecImagOut = stateVecOut.imag;
    // qreal *stateVecRealOut_0, *stateVecImagOut_0;
    // qreal *stateVecRealOut_1, *stateVecImagOut_1;
    // if (isUpper == 0)
    // {
    //     stateVecRealOut_0 = stateVecRealLo;
    //     stateVecImagOut_0 = stateVecImagLo;
    // }
    // else
    // {
    //     stateVecRealOut_0 = stateVecRealUp;
    //     stateVecImagOut_0 = stateVecImagUp;
    // }

#ifdef _OPENMP
#pragma omp parallel default(none)                                         \
    shared(stateVecRealUp, stateVecImagUp, stateVecRealLo, stateVecImagLo, \
           rot1Real_up, rot1Imag_up, rot2Real_up, rot2Imag_up, rot1Real_lo, rot1Imag_lo, rot2Real_lo, rot2Imag_lo) private(thisTask, stateRealUp, stateImagUp, stateRealLo, stateImagLo)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
        ...
        for (thisTask = 0; thisTask < numTasks; thisTask++)
        {
            ...
            // state[indexUp] = alpha * state[indexUp] - conj(beta)  * state[indexLo]
            stateVecRealUp[thisTask] = rot1Real_up * stateRealUp - rot1Imag_up * stateImagUp + rot2Real_up * stateRealLo + rot2Imag_up * stateImagLo;
            stateVecImagUp[thisTask] = rot1Real_up * stateImagUp + rot1Imag_up * stateRealUp + rot2Real_up * stateImagLo - rot2Imag_up * stateRealLo;

            stateVecRealLo[thisTask] = rot1Real_lo * stateRealUp - rot1Imag_lo * stateImagUp + rot2Real_lo * stateRealLo + rot2Imag_lo * stateImagLo;
            stateVecImagLo[thisTask] = rot1Real_lo * stateImagUp + rot1Imag_lo * stateRealUp + rot2Real_lo * stateImagLo - rot2Imag_lo * stateRealLo;
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(sizeBlock, sizeHalfBlock, stateVecReal, stateVecImag, alphaReal, alphaImag, betaReal, betaImag) private(thisTask, thisBlock, indexUp, indexLo, stateRealUp, stateImagUp, stateRealLo, stateImagLo, controlBit)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(sizeBlock, sizeHalfBlock, stateVecReal, stateVecImag, u, ctrlQubitsMask, ctrlFlipMask) private(thisTask, thisBlock, indexUp, indexLo, stateRealUp, stateImagUp, stateRealLo, stateImagLo)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(sizeBlock, sizeHalfBlock, stateVecReal, stateVecImag, u) private(thisTask, thisBlock, indexUp, indexLo, stateRealUp, stateImagUp, stateRealLo, stateImagLo, controlBit)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#pragma omp parallel default(none)                                                                           \
    shared(stateVecRealUp, stateVecImagUp, stateVecRealLo, stateVecImagLo, stateVecRealOut, stateVecImagOut, \
           rot1Real, rot1Imag, rot2Real, rot2Imag) private(thisTask, stateRealUp, stateImagUp, stateRealLo, stateImagLo, controlBit)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#pragma omp parallel default(none)                                                                           \
    shared(stateVecRealUp, stateVecImagUp, stateVecRealLo, stateVecImagLo, stateVecRealOut, stateVecImagOut, \
           rot1Real, rot1Imag, rot2Real, rot2Imag, ctrlQubitsMask, ctrlFlipMask) private(thisTask, stateRealUp, stateImagUp, stateRealLo, stateImagLo)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(sizeBlock, sizeHalfBlock, stateVecReal, stateVecImag) private(thisTask, thisBlock, indexUp, indexLo, stateRealUp, stateImagUp)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(stateVecRealIn, stateVecImagIn, stateVecRealOut, stateVecImagOut) private(thisTask)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(sizeBlock, sizeHalfBlock, stateVecReal, stateVecImag) private(thisTask, thisBlock, indexUp, indexLo, stateRealUp, stateImagUp, controlBit)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(stateVecRealIn, stateVecImagIn, stateVecRealOut, stateVecImagOut) private(thisTask, controlBit)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(stateVecRealIn, stateVecImagIn, stateVecRealOut, stateVecImagOut, realSign, imagSign) private(thisTask)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(sizeBlock, sizeHalfBlock, stateVecReal, stateVecImag, recRoot2) private(thisTask, thisBlock, indexUp, indexLo, stateRealUp, stateImagUp, stateRealLo, stateImagLo)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#pragma omp parallel default(none)                                                                           \
    shared(stateVecRealUp, stateVecImagUp, stateVecRealLo, stateVecImagLo, stateVecRealOut, stateVecImagOut, \
           recRoot2, sign) private(thisTask, stateRealUp, stateImagUp, stateRealLo, stateImagLo)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#pragma omp parallel for default(none)                                                                   \
    shared(stateVecSize, stateVecReal, stateVecImag) private(index, targetBit, stateRealLo, stateImagLo) \
        schedule(static)
#endif
    for (index = 0; index < stateVecSize; index++)
    {
...
#ifdef _OPENMP
#pragma omp parallel for default(none)                                                                    \
    shared(stateVecSize, stateVecReal, stateVecImag) private(index, bit1, bit2, stateRealLo, stateImagLo) \
        schedule(static)
#endif
    for (index = 0; index < stateVecSize; index++)
    {
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(stateVecSize, stateVecReal, stateVecImag, mask) private(index, stateRealLo, stateImagLo)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(stateVecSize, stateVecReal, stateVecImag, mask) private(index, fac, stateReal, stateImag)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel                                                                                                                   \
    shared(localIndNextDiag, numPrevDiags, diagSpacing, stateVecReal, numDiagsInThisChunk) private(visitedDiags, basisStateInd, index) \
        reduction(+                                                                                                                    \
                  : zeroProb)
#endif
    {
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(numTasks, sizeBlock, sizeHalfBlock, stateVecReal, stateVecImag, renorm, outcome) private(thisTask, thisBlock, index)
#endif
    {
        if (outcome == 0)
        {
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(reVec, imVec, numTasks, qb1, qb2) private(thisTask, ind00, ind01, ind10, re01, re10, im01, im10)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel default(none) \
    shared(reVec, imVec, rePairVec, imPairVec, numLocalAmps, globalStartInd, pairGlobalStartInd, qb1, qb2) private(localInd, globalInd, pairLocalInd, pairGlobalInd)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
...
#ifdef _OPENMP
#pragma omp parallel \
    shared(vecRe1, vecIm1, vecRe2, vecIm2, vecReOut, vecImOut, facRe1, facIm1, facRe2, facIm2, numAmps) private(index, re1, im1, re2, im2, reOut, imOut)
#endif
    {
#ifdef _OPENMP
#pragma omp for schedule(static)
