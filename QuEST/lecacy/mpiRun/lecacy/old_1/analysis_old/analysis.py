...
plt.plot(qubit_array, dur_array)
plt.xlabel("#qubits")
plt.ylabel("time/s")
title = "Time vs Qubits, numThread=%d, slot1=%d, slot2=%d"%(nThreads, slot1, slot1)
plt.title(title)
plt.savefig("../result_graphs/%s"%title)

plt.figure()
plt.plot(qubit_array, realMem_array)
plt.xlabel("#qubits")
plt.ylabel("realMem/B")
title = "realMem vs Qubits, numThread=%d, slot1=%d, slot2=%d"%(nThreads, slot1, slot1)
plt.title(title)
plt.savefig("../result_graphs/%s"%title)

plt.figure()
plt.plot(qubit_array, realPeak_array)
plt.xlabel("#qubits")
plt.ylabel("realMemPeak/B")
title = "realPeak vs Qubits, numThread=%d, slot1=%d, slot2=%d"%(nThreads, slot1, slot1)
plt.title(title)
plt.savefig("../result_graphs/%s"%title)

plt.figure()
plt.plot(qubit_array, virtMem_array)
plt.xlabel("#qubits")
plt.ylabel("virtMem/B")
title = "virtMem vs Qubits, numThread=%d, slot1=%d, slot2=%d"%(nThreads, slot1, slot1)
plt.title(title)
plt.savefig("../result_graphs/%s"%title)

plt.figure()
plt.plot(qubit_array, virtPeak_array)
plt.xlabel("#qubits")
plt.ylabel("virtMemPeak/B")
title = "virtPeak vs Qubits, numThread=%d, slot1=%d, slot2=%d"%(nThreads, slot1, slot1)
plt.title(title)
plt.savefig("../result_graphs/%s"%title)
