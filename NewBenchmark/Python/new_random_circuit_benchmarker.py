...
# to give simulator the seed and gate-fuse flag
...
if __name__ == '__main__':
    ...
    for rep in range(params['numRepetitions']):
        ...
        with open(params["filename"], 'a+') as file:
            file.write("%d %d %d %d %f %d %d\n"%(params["numThreads"], params["circuitDepth"], params["numQubits"], params["numRepetitions"], dur, mem['VmRSS'], mem['VmSize']))
